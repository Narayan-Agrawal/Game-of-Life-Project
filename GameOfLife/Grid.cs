...
namespace GameOfLife
{
    public class Grid
    {
        ...
        {
            get { if (GridObj.Count <= x || ColumnCount <= y) throw new ArgumentOutOfRangeException("Cell's Index Argument out of bound"); return GridObj[x].Cells[y]; }
            set { if (GridObj.Count <= x || ColumnCount <= y) throw new ArgumentOutOfRangeException("Cell's Index Argument out of bound"); GridObj[x].Cells[y] = value; }
        }
        /// <summary>
        ...
        {
            get { if (GridObj.Count <= x) throw new ArgumentOutOfRangeException("Row's Index Argument out of bound"); return GridObj[x]; }
            set { if (GridObj.Count <= x) throw new ArgumentOutOfRangeException("Row's Index Argument out of bound"); GridObj[x] = value; }
        }
